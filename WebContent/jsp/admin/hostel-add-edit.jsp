		...
		<div class="main">
			...
			<section id="content">
				...
				<article class="col2">
					...
					<form id="hostel-form" action="javascript:void(null);"
						method="post" onsubmit="addEditHostel()" class="form">
						<c:choose>
							<c:when test="${not empty hostel}">
						...
						<div class="wrapper">
							...
							(*): <input type="text" name="name" value="${hostel.name}"
								required pattern="[А-Я]{1}[А-Яа-я ]+"  maxlength="30" class="input"> <br />
						</div>
						...
						<div class="wrapper">
							...
							(*): <input type="text" name="city" required pattern="[А-Я]{1}[А-Яа-я ]+" maxlength="30"
						...
						<div class="wrapper">
							...
							(*): <input type="number" name="standart_price" required
								value="${hostel.standartPrice}" pattern="[1-9]{1}[0-9]+" class="input">
							<br />
						</div>
						<div class="wrapper">
